  ...
  const handleSendMessage = async () => {
    ...
    if (
      ...
      const {
        ...
        duration,
        images,
      } = await generateAIResponse(messagesForAI, selectedModel);
    ...
    try {
      ...
      const { result: aiText, duration, ai_message, images } = responseData;
      console.log("DEBUG: AI message from response:", ai_message);
      console.log("DEBUG: Images from response:", images);
      console.log(
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className="h-16 border-b border-border flex items-center justify-between px-4 sm:px-6 flex-shrink-0">
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <div className="relative" data-retrieval-container>
              <button
                onClick={() =>
                ...
                title="Retrieval Methods - Select retrieval strategy"
              >
